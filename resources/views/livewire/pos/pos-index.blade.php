    ...
    <div class="relative flex flex-col h-full p-2 bg-red-300">
        ...
        <div class="flex-grow">
            <div class="flex flex-col justify-between h-full">
                <div class="flex-grow h-0 overflow-y-auto bg-white">
                        ...
                        <tbody class="divide-y-2">
                            ...
                            <tr>
                                <td class="p-5 text-center" colspan="6">
                                    <i class="text-6xl icofont-bar-code"></i>
                                    <i class="text-6xl icofont-sale-discount"></i>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
                ...
                <div>
                    @if ($selected_product)
                    <div class="p-3 space-y-4 text-sm bg-white border-2">
